...
ENV APP_NAME=timeeasy-0.0.1-SNAPSHOT.jar
ENV HOME=/app
ENV APP_HOME=/app
ENV APP_USER=app
...
CMD sudo -u $APP_USER java -jar -Dspring.profiles.active=$SPRING_PROFILES_ACTIVE $APP_HOME/$APP_NAME
